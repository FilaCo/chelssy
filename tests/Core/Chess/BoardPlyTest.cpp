...
[[nodiscard]] auto plyCases() {
  ...
  return testing::Values(
      PlyTestParam{.name = "quiet_knight_move",
                   .fenBefore = Fen::startingPositionStr,
                   .ply = Ply{Square::fromStr("g1"), Square::fromStr("f3"),
                              Quiet},
                   .fenAfter =
      ...
      PlyTestParam{.name = "capture_resets_ply_clock",
                   .fenBefore = "4k3/8/8/3p4/4N3/8/8/4K3 w - - 5 20",
                   .ply = Ply{Square::fromStr("e4"), Square::fromStr("d5"),
                              Capture},
      ...
      PlyTestParam{.name = "white_king_castle",
                   .fenBefore = "4k3/8/8/8/8/8/8/4K2R w K - 3 10",
                   .ply = Ply{Square::fromStr("e1"), Square::fromStr("g1"),
                              KingCastle},
                   .fenAfter = "4k3/8/8/8/8/8/8/5RK1 b - - 4 10"},
      PlyTestParam{.name = "white_queen_castle",
                   .fenBefore = "4k3/8/8/8/8/8/8/R3K3 w Q - 0 10",
                   .ply = Ply{Square::fromStr("e1"), Square::fromStr("c1"),
                              QueenCastle},
                   .fenAfter = "4k3/8/8/8/8/8/8/2KR4 b - - 1 10"},
      PlyTestParam{.name = "black_king_castle",
                   .fenBefore = "4k2r/8/8/8/8/8/8/4K3 b k - 0 10",
                   .ply = Ply{Square::fromStr("e8"), Square::fromStr("g8"),
                              KingCastle},
                   .fenAfter = "5rk1/8/8/8/8/8/8/4K3 w - - 1 11"},
      PlyTestParam{.name = "black_queen_castle",
                   .fenBefore = "r3k3/8/8/8/8/8/8/4K3 b q - 0 10",
                   .ply = Ply{Square::fromStr("e8"), Square::fromStr("c8"),
                              QueenCastle},
                   .fenAfter = "2kr4/8/8/8/8/8/8/4K3 w - - 1 11"},
      PlyTestParam{.name = "knight_promo",
                   .fenBefore = "4k3/P7/8/8/8/8/8/4K3 w - - 0 30",
                   .ply = Ply{Square::fromStr("a7"), Square::fromStr("a8"),
                              KnightPromo},
                   .fenAfter = "N3k3/8/8/8/8/8/8/4K3 b - - 0 30"},
      PlyTestParam{.name = "bishop_promo",
                   .fenBefore = "4k3/P7/8/8/8/8/8/4K3 w - - 0 30",
                   .ply = Ply{Square::fromStr("a7"), Square::fromStr("a8"),
                              BishopPromo},
                   .fenAfter = "B3k3/8/8/8/8/8/8/4K3 b - - 0 30"},
      PlyTestParam{.name = "rook_promo",
                   .fenBefore = "4k3/P7/8/8/8/8/8/4K3 w - - 0 30",
                   .ply = Ply{Square::fromStr("a7"), Square::fromStr("a8"),
                              RookPromo},
                   .fenAfter = "R3k3/8/8/8/8/8/8/4K3 b - - 0 30"},
      PlyTestParam{.name = "queen_promo",
                   .fenBefore = "4k3/P7/8/8/8/8/8/4K3 w - - 0 30",
                   .ply = Ply{Square::fromStr("a7"), Square::fromStr("a8"),
                              QueenPromo},
      ...
      PlyTestParam{.name = "king_move_clears_both_rights",
                   ...
                   .ply = Ply{Square::fromStr("e1"), Square::fromStr("e2"),
                              Quiet},
                   .fenAfter = "r3k2r/8/8/8/8/8/4K3/R6R b kq - 1 10"},
      PlyTestParam{.name = "rook_move_clears_kingside_right",
                   .fenBefore = "r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 10",
                   .ply = Ply{Square::fromStr("h1"), Square::fromStr("g1"),
                              Quiet},
                   .fenAfter = "r3k2r/8/8/8/8/8/8/R3K1R1 b Qkq - 1 10"},
      PlyTestParam{.name = "rook_capture_clears_both_sides_rights",
                   .fenBefore = "r3k2r/8/8/8/8/8/8/R3K2R w KQkq - 0 10",
                   .ply = Ply{Square::fromStr("a1"), Square::fromStr("a8"),
                              Capture},
